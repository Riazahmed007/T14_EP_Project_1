  ...
  <div class="row">
    ...
    <div class="col-lg-12">
          ...
          <div class="card-header p-3">
            <h5 class="mb-0"><i class="fas fa-tasks me-2"></i>Completed</h5>
          </div>
          ...
          <thead>
                <tr class="">
                  ...
                  <th  width="20%" class="text-center text-secondary">View</th>
                </tr>
              </thead>
          <!-- Table Body  -->
           <tbody> 
            ...
            <?php
                ...
                $employee_id=$id;
                $sql = "SELECT * FROM task_tasks WHERE employee_id=$employee_id AND task_status=1 ORDER BY id DESC"; 
                ...
                while($row = $result->fetch_assoc()) {
                  ...
                  $assignDate=date_create($assignDate);
              ...
              //  priority class dynamic CSS 
                  ...
                  <td width="10%" class="text-center align-middle text-secondary">
                  ...
                  <td width="20%" class="text-center align-middle text-secondary">
