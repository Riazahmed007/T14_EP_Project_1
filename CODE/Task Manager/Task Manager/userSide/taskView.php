  ...
  <div class="container"> <!-- container start -->
    ...
    <div class="col-lg-9"> <!-- col-lg-9 start -->
      <div class="row">
          ...
          <div class="col-lg-12">
              <div class="bg-white card  p-3 " style=" background-color:   rgb(233, 238, 255);">  <!--  Card start -->
               
                  <div class="d-flex justify-content-between">

                  <h3 class=""><strong><?php echo $row['task_name']; ?></strong></h3>
                  <button
                type="button"
                class="  fw-bold me-2 btnn"
          ...
          <div class="col-lg-12">
              <div class=" card  p-3 " >  <!--  Card start -->
                
                  <p class="  mb-2 ">  <?php echo $row['task_description']; ?> </p>
      ...
      <div class="col-lg-3"> <!-- col-lg-3 start -->
        ...
        <li class="list-group-item text-center card-header  "  ><strong class="">Task Details</strong></li>
        <li class="list-group-item text-center   py-3" ><?php echo $days ?></li>
        <li class="list-group-item text-center   py-3 d-flex justify-content-center" > <div class="d-flex align-items-center ">
       ...
       <?php
                  $taskStatus=$row['task_status'];
                  if($taskStatus==0){
                   echo' <li class="list-group-item text-center   py-3" >
                   <a class=""  href="updateStartSql.php?id='.$id.'" > <button class="btn btn-success">Start Working</button></a>
                   </li>';
                  }
                  else{
                    if($taskStatus==2){
                      echo' <li class="list-group-item text-center   py-3" >
                      <a class=""  href="updateDoneSql.php?id='.$id.'" > <button class="submitbtn">Submit</button></a>
                      </li>';
                    }else{
                     echo'<li class="list-group-item text-center   py-3" >
                     <a class=""  href="" > <button class="submitbtn">Completed</button></a>
                     </li>';
                  }
                }
        ...
        <li class="list-group-item text-center card-header   " style="border-bottom:1px solid #4c545c"><strong>Notes</strong></li>
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
         ...
         $submitDate = date_format($submitDate, 'd-M-y');
         echo' <p class="mt-2"><span class="badge  ">'.$submitDate.'</span></p>';
         echo'<p>'.$row['notes'].'</p>';
         echo'<hr>';
        ...
        <div class="card-body p-5 text-center">
         ...
         <form action="notesSql.php" method="post" enctype="multipart/form-data">
          <div class="form-outline mb-4">
            <input type="text" name="notes" placeholder="Add Note here" class="form-control form-control-lg  transparent-input" />
          </div>
          
          <div class="form-outline mb-4">
            <input type="hidden" name="task_id" value="<?php echo $id; ?>" class="form-control form-control-lg transparent-input" />
          </div>
